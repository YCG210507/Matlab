...
%   Advanced option
%   ---------------
%   [Y,W] = DCTN(X,DIM,W) uses and returns the weights that are used by the
%   code. If DCTN is required for several large arrays of same size, the
...
%   Reference
%   ---------
%   Narasimha MJ and Peterson AM, On the computation of the discrete cosine
