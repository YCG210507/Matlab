...
function ET0=PMET0(yearday,Tmean,Tmax,Tmin,RHmean,wind,sunshineHour,DEM,latitude)	
...
wind2 = wind*4.87/(log(67.8*10-5.42));%%风速（m/s）转换到两米 一般国家站风速测点10-12米，此处10米可根据实际情况更改
G = 0;%土壤热通量G（MJm-2day-1）日尺度上忽略，记为0   G = 0.14
Rn=Rns-Rnl;%净辐射Rn(MJ m-2day-1)
ET0 = (0.408*deta*(Rn-G)+gama*(900/(Tmean+273.16))*wind2*VPD)/(deta+gama+gama*0.34*wind2);%%mm
end
